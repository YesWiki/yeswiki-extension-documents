...
$GLOBALS['translations'] = array_merge(
    ...
    array(
        ...
        'DOCUMENTS_INVALID_CONFIG_ERROR' => 'Invalid configuration for document type \'%{key}\'. Expected an array with \'label\', \'description\', \'service\' and \'url\'.',
        'DOCUMENTS_MISSING_CREDENTIALS_ERROR' => 'Missing configuration for document type \'%{key}\'. Expected not empty value in the configuration config[\'documentsCredentials\'][\'%{value}\'].',
        'DOCUMENTS_NO_URL_GENERATED' => 'No URL generated',
        'DOCUMENTS_CALLBACK_NOT_SIGNED' => "OnlyOffice callback refused: missing or invalid signature.",
        'DOCUMENTS_CALLBACK_FOREIGN_URL' => "OnlyOffice callback refused: the download url does not point at the configured server.",
        'DOCUMENTS_SECRET_TOO_SHORT' => "The OnlyOffice secret set in config['documentsCredentials']['%{key}'] is too short: it must be at least 32 characters long.",
        ...
        'DOCUMENTS_DOC_IN_PAGE' => 'Doc %{type} %{page}',
